      ...
      <TableBody>
        {props.minimums.map((mins, i) => (
          <TableRow key={i}>
            ...
            <TableCell>
              <MinimumsCell mins={mins.cat_a} />
            </TableCell>
            <TableCell>
              <MinimumsCell mins={mins.cat_b} />
            </TableCell>
            <TableCell>
              <MinimumsCell mins={mins.cat_c} />
            </TableCell>
            <TableCell>
              <MinimumsCell mins={mins.cat_d} />
            </TableCell>
          </TableRow>
        ))}
      </TableBody>
...
const ApproachDetailPanel = (row: MRT_Row<Approach>, airports: AirportsMap) => {
  ...
  const runway = airport.runways
    .filter((r) => r.name == approach.runway)
    .shift();
    ...
    <Grid container spacing={2}>
      <Grid item xs={5}>
        ...
        <Typography variant="subtitle1">
          {airport.name} ({approach.airport})
        </Typography>

        {runway && (
          <Typography variant="subtitle2">
            <Tooltip title="Runway Threshold Elevation">
              <span>RTE </span>
            </Tooltip>
        ...
        {approach.text_comments.length > 0 && (
          <Paper sx={{ p: 2, m: 2 }} elevation={3}>
            ...
            <Typography variant="body2">{approach.text_comments}</Typography>
          </Paper>
        )}
      </Grid>
...
export default function ApproachTable(props: {
  dttpCycleNumber: string;
  data: Approach[];
