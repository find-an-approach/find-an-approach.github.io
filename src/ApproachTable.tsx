...
const ApproachTitle = ({ title, plate_file, dttpCycleNumber }: { title: React.ReactNode, plate_file: string, dttpCycleNumber: string }) => {
        ...
        columnHelper.group({
            ...
            columns: [
                ...
                columnHelper.accessor('approach_name', {
                    ...
                    Cell: ({ renderedCellValue, row }) => <ApproachTitle dttpCycleNumber={props.dttpCycleNumber} title={renderedCellValue} plate_file={row.original.plate_file} />
                }),
